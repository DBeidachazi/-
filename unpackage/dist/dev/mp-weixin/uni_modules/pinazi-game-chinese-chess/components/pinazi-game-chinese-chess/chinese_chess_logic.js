"use strict";
const uni_modules_pinaziGameChineseChess_components_pinaziGameChineseChess_calc_pawn_targets = require("./calc_pawn_targets.js");
const uni_modules_pinaziGameChineseChess_components_pinaziGameChineseChess_evaluate_panel_weight = require("./evaluate_panel_weight.js");
var init_panel_arr = [
...
var chinese_chess_logic = {
  ...
  calcAllTargetPoints(current_item, all_matrix) {
    return uni_modules_pinaziGameChineseChess_components_pinaziGameChineseChess_calc_pawn_targets.calc_pawn_targets.getPointsArr(current_item, all_matrix);
  },
  calcPanelVals(all_matrix) {
    return uni_modules_pinaziGameChineseChess_components_pinaziGameChineseChess_evaluate_panel_weight.evaluate_panel_weight.evaluate(all_matrix);
  },
...
exports.chinese_chess_logic = chinese_chess_logic;
